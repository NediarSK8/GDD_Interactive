...
export const GoogleDriveIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 48 48">
        <path fill="#4CAF50" d="M32.4,18.3l-7.4-12.8L10.3,34.4l7.4,12.8L32.4,18.3z"/>
        <path fill="#FFC107" d="M10.3,12.8L2.9,25.6l14.7,8.5l7.4-12.8L10.3,12.8z"/>
        <path fill="#2196F3" d="M45.1,25.6L32.4,47.2l-7.4-12.8L40,12.8L45.1,25.6z"/>
    </svg>
);
...
export const MagicWandIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.245 4.5 4.5 0 118.4-2.475c0 1.039-.44 2.002-1.215 2.754a3 3 0 00-1.008 2.836z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 5.25a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008z" />
    </svg>
);

export const AiInsightIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
...
export const HeadingLevelIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3v18M3 3h9M3 12h9m-9 9h9M15 3h6m-3 0v18" />
    </svg>
);
